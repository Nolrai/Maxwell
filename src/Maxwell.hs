...
okLAB l a b = cieXYZ x y z
  where
    v = toXYZfromLMS $ (\d -> d ** (1/3)) <$> toLMSFromOk l a b
    x = v X
    y = v Y
    z = v Z
...
m1 LL AStar = 0.0329845436
m1 LL BStar = 0.0482003018

m1 MM Light = 0.3618667424
m1 MM AStar = 0.9293118715
m1 MM BStar = 0.0482003018

m1 SS Light = -0.1288597137
m1 SS AStar = 0.0361456387
m1 SS BStar = 0.6338517070

m2 :: XYZ -> LMS -> Double
m2 X LL = 0.2104542553
m2 X MM = 1.9779984951
m2 X SS = 0.0259040371
 
m2 Y LL = 0.7936177850
m2 Y MM = -2.4285922050
m2 Y SS = 0.7827717662
 
m2 Z LL = -0.0040720468
m2 Z MM = 0.4505937099
